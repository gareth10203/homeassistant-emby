...
Emby can display an on-screen message through `embymedia.send_message` or a
notification entity, but it cannot play Home Assistant's generated TTS URL as
an announcement.
